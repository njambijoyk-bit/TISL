...
const AuctionListPage      = lazy(() => import('./core/pages/customer/AuctionListPage'));
const AuctionDetailPage    = lazy(() => import('./core/pages/customer/AuctionDetailPage'));
...
const MyProjects           = lazy(() => import('./core/pages/customer/MyProjects'));
const MyProjectDetail      = lazy(() => import('./core/pages/customer/MyProjectDetail'));
...
const AdminAuctions      = lazy(() => import('./core/pages/admin/AdminAuctions'));
const AdminAuctionDetail = lazy(() => import('./core/pages/admin/AdminAuctionDetail'));
const AdminAuctionCreator = lazy(() => import('./core/pages/admin/AdminAuctionCreator'));
const AdminAuctionOrders   = lazy(() => import('./core/pages/admin/AdminAuctionOrders'));
const AdminAuctionOrderPayments = lazy(() => import('./core/pages/admin/AdminAuctionOrderPayments'));
const AdminAuctionOrderDetail = lazy(() => import('./core/pages/admin/AdminAuctionOrderDetail'));
...
const ProjectDashboard   = lazy(() => import('./core/pages/admin/ProjectDashboard'));
const Projects           = lazy(() => import('./core/pages/admin/Projects'));
const ProjectCreate      = lazy(() => import('./core/pages/admin/ProjectCreate'));
const ProjectDetail      = lazy(() => import('./core/pages/admin/ProjectDetail'));
