...
import { employeesAPI } from '../../../../../_shared/api/index';
...
export default function EmployeeBulkPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await employeesAPI.bulkImport(formData);
      setUploadResult({ success: true, message: 'Employees imported successfully!' });
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '24px 28px' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--text-muted)', marginTop: 4 }}>
            Upload a CSV or Excel file to add or update employees in bulk
          </p>
        </div>
        ...
        <div style={{
          ...
          <strong style={{ fontSize: 13, color: 'var(--text-primary)' }}>Tips</strong>
          <ul style={{ margin: '10px 0 0', paddingLeft: 20, fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.8 }}>
            ...
            <li><strong>department</strong> is required (e.g., Sales, Finance, Logistics)</li>
            <li>Use <code>employment_type</code>: <code>full_time</code>, <code>part_time</code>, <code>contract</code>, or <code>intern</code></li>
            <li>Dates should be in <code>YYYY-MM-DD</code> format (Excel dates auto-convert)</li>
            <li>JSON fields (<code>skills</code>, <code>certifications</code>) should be valid JSON arrays e.g. <code>["Recruitment","Policy"]</code></li>
            <li>Existing employees (by email) will be updated; new ones will be created with a User record</li>
          </ul>
        </div>
