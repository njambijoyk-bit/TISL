...
import txFlowchartHtml from './txflowchart.html?url';

export default function TxFlowchartPage() {
  const navigate = useNavigate();
  const [showNav, setShowNav] = useState(false);

  useEffect(() => {
    document.title = 'TISL Transaction Flowchart — System Overview';
  }, []);
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <span style={{ color: '#cdd6e0' }}>Transaction Flowchart</span>
      </div>
      ...
      <iframe
        ...
        title="TISL Transaction Flowchart"
      />
