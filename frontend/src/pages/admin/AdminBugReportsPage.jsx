...
/**
 * AdminBugReportsPage — /admin/bug-reports
 */
export default function AdminBugReportsPage() {
  ...
  return (
    ...
    <div className="bug-container-xl">
      ...
      {/* filters */}
      <FilterBar filters={filters} onChange={handleFilter} onClear={clearFilters} />
        ...
        {!loading && reports.map(r => (
          ...
          >
            ...
            <div className="bug-flex-col bug-min-w-0" style={{ gap: 2 }}>
              <span className="bug-text-sm bug-font-medium bug-text truncate bug-group-link" style={{ display: 'block' }}>
                {r.title}
              </span>
            ...
            <div className="bug-flex-col bug-justify-center">
              <span className="bug-text-xs bug-text-secondary">
