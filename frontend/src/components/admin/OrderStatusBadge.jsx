const STATUS_CONFIG = {
  ...
  ready_for_pickup: { label: 'Ready for Pickup', color: '#10b981', bg: 'rgba(16,185,129,0.1)',  border: 'rgba(16,185,129,0.25)'  },
  shipped:          { label: 'Shipped',          color: '#a855f7', bg: 'rgba(168,85,247,0.1)',  border: 'rgba(168,85,247,0.25)'  },
  delivered:        { label: 'Delivered',        color: '#10b981', bg: 'rgba(16,185,129,0.1)',  border: 'rgba(16,185,129,0.25)'  },
