/**
 * AlgorithmBanner — with useFloatingWidgetAudio wired in
 */
    ...
    return (
      <button
        ...
        style={{
          ...
          border: `1px solid ${meta.border}`, borderLeft: 'none',
        ...
        <div style={{ padding: '10px 14px', display: 'flex', flexDirection: 'column', gap: 8 }}>
          {profile.insights.slice(0, 2).map((ins, i) => (
            <div key={i} style={{
              ...
              {ins.cta && ins.ctaLink && (
                <button
                  onClick={() => { audio.playCta(); navigate(ins.ctaLink); }}
                  onMouseEnter={audio.playHover}
                  style={{
